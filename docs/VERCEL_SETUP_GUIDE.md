...
```
Name: MONGODB_URI
Value: mongodb+srv://Vercel-Admin-comic-collection-tracker:6wxqoG86JNapg630@comic-collection-tracke.aufn0iz.mongodb.net/comic-collection?retryWrites=true&w=majority&appName=comic-collection-tracker
...
Value: 394889779aa49e3f2cb5f464c0ffeefddb542dd2
Environment: ✅ Production only
```
...
```
Name: MONGODB_URI
Value: mongodb+srv://Vercel-Admin-comic-collection-tracker:6wxqoG86JNapg630@comic-collection-tracke.aufn0iz.mongodb.net/comic-collection-preview?retryWrites=true&w=majority&appName=comic-collection-tracker
